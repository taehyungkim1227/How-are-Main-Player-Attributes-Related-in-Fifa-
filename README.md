...
## Part 3: Exploratory Data Analysis
  ...
  - The overall statistic seems to be normally distributed.
...
## Part 4: Model Building and Evaluation
  ...
  - (Bonus: for goalkeepers, to check for linearity, I created a residual plot of residuals vs predicted y-values. The datapoints did not follow a specific pattern, indicating that there is a significant chance of linearity among the goalkeeper sub-dataset. The visualization below reflects this.)
